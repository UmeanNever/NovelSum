...
- 📖 **Paper**: [Measuring Data Diversity for Instruction Tuning: A Systematic Analysis and A Reliable Metric](https://arxiv.org/pdf/2502.17184). Accepted to **ACL 2025** (Main Conference). 🎉
